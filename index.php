				...
				<div class="owl-item home_slider_item">
					...
					<div class="home_slider_content text-center">
						<div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
							<h1 style="font-size: 700%;">Sun Apartments</h1>
							<h1></h1>
							<div class="button home_slider_button"><div class="button_bcg"></div><a href="reservas.php">Reservar Agora<span></span><span></span><span></span></a></div>
						</div>
					</div>
				</div>
				<?php /*
	...
	*/ ?>	
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="intro_title text-center">Nós temos os melhores apartamentos</h2>
				</div>
			</div>
			<div class="row">
			...
			<div class="row intro_items">
				...
				<!-- Intro Item -->
				<?php
				$busca_rand = mysqli_query($link, "SELECT * FROM apartamento ORDER BY RAND() LIMIT 3");
				while ($info_rand = mysqli_fetch_array($busca_rand)) {
					$id_prod = $info_rand['id'];
					$titulo = $info_rand['titulo'];
					$descricao = $info_rand['descricao'];
					$foto_destaque = $info_rand['foto_destaque'];
				?>
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<?php /* <div class="intro_date">May 25th - June 01st</div> */ ?>
							<div class="button intro_button"><div class="button_bcg"></div><a href="produto.php?id=<?php echo $id_prod; ?>">Reservar<span></span><span></span><span></span></a></div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<div class="offers_link"><a href="reservas.php">read more</a></div>
								</div>
							</div>
						</div>
					</div>
