...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles/reservas.css">
</head>
...
<body>
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#">Sun Apartments</a></div>
						</div>
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_lirst">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Reservas</div>
		</div>
	</div>
		...
		*/ ?>	
		<div class="intro">
			<div class="container-fluid">
				<div class="row intro_items" style="padding: 15px;">
					<?php
					$busca_imo = mysqli_query($link, "SELECT * FROM apartamento");
					if (mysqli_num_rows($busca_imo) > 0) {
						while($info_imo = mysqli_fetch_array($busca_imo)) {
							$id = $info_imo['id'];
							$titulo = $info_imo['titulo'];
							$descricao = $info_imo['descricao'];
							$foto_destaque = $info_imo['foto_destaque'];
							?>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<div class="modal-header">
											<h4 class="modal-title">Fotografias do <?php echo $titulo; ?></h4>
										...
										<div class="modal-body">
											<?php
											$busca_fotos = mysqli_query($link, "SELECT * FROM galeria WHERE id_produto='$id'");
											if (mysqli_num_rows($busca_fotos) > 0) {
												while($loop_fotos = mysqli_fetch_array($busca_fotos)) {
													...
													?>
													<img src="<?php echo $imagem; ?>" style="height: 200px; width: 250px; padding: 8px;" style="display: inline-block;">
													<?php
												}
											}
											?>
							...
							<div class="col-lg-3 intro_col" id="coluna"> 
								<div class="intro_item">
									<div class="intro_item_overlay"></div>
									<!-- Image by https://unsplash.com/@dnevozhai -->
									<div class="intro_item_background" style="background-image:url(<?php echo $foto_destaque; ?>)"></div>
									<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
										<div class="button intro_button"><div class="button_bcg"></div><a href="produto.php?id=<?php echo $id; ?>">Reservar<span></span><span></span><span></span></a></div>



										<div class="intro_center text-center">
											<h1 style="font-size: 150%;"><?php echo $titulo; ?></h1>
										</div>
										<br>
										<a href="#" class="btn btn-warning" data-toggle="modal" data-target="#<?php echo $id; ?>">Fotografias</a>
									</div>
								</div> 
							</div>
							<?php
	...
	<footer class="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						<div class="footer_title">Lorem ipsum</div>
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						<div class="footer_title">Ipsum</div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="sobre.php">about us</a></li>
